...
def main():
    ...
    if logo:
        ...
        with col2:
            st.title("**Seja bem vindo ao Simulador da JMD HAMOA (Jataí)**")
    else:
    ...
    with st.form("simulador_form"):
        ...
        with col2:
            ...
            qtd_parcelas = st.number_input("Qtd. de Parcelas/Meses:Plano só balões 48 meses = 4 balões anual; 8 balões semestrais", min_value=0, max_value=168, step=1, key="qtd_parcelas")
            
            if qtd_parcelas > 168: st.warning("A quantidade máxima de parcelas permitida é 168.")
            # --- FIM DA MODIFICAÇÃO ---
