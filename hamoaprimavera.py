...
def main():
    ...
    if logo:
        ...
        with col2:
            st.title("**Seja bem vindo ao Simulador da JMD HAMOA (156m Faixas)**")
    else:
        st.title("Simulador Imobiliária Celeste")
        
    # --- INÍCIO DA MODIFICAÇÃO (Taxa máxima 0.79%) ---
    ...
    if submitted:
        try:
            # --- INÍCIO DA MODIFICAÇÃO (LÓGICA DE FAIXAS DE JUROS) ---
